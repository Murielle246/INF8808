...
exports.generateGV3 = generateGV3;
exports.setCanvasSizeV3 = setCanvasSizeV3;
exports.appendAxesV3 = appendAxesV3;
...
function generateG2(width, height, margin) {
  var g21 = d3.select('.graph21').select('svg').append('g').attr('id', 'map-g211').attr('class', 'group').attr('width', width).attr('height', height).attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
  var g22 = d3.select('.graph22').select('svg').append('g').attr('class', 'group').attr('id', 'map-g221').attr('width', width).attr('height', height).attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
  var g23 = d3.select('.graph23').select('svg').append('g').attr('class', 'group').attr('id', 'map-g231').attr('width', width).attr('height', height).attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
  return [g21, g22, g23];
}

function appendAxes(g2, g1) {
  // view 2 axes
  g2[0].append('g').attr('class', 'x axis');
  g2[0].append('g').attr('class', 'y axis21');
  g2[1].append('g').attr('class', 'x axis');
  g2[1].append('g').attr('class', 'y axis22');
  g2[2].append('g').attr('class', 'x axis');
  g2[2].append('g').attr('class', 'y axis23'); // view 1 axes

  g1[0].append('g').attr('class', 'x axis1');
  g1[0].append('g').attr('class', 'y axis11');
  g1[1].append('g').attr('class', 'x axis1');
  g1[1].append('g').attr('class', 'y axis12');
  g1[2].append('g').attr('class', 'x axis1');
  g1[2].append('g').attr('class', 'y axis13');
}
/**
...
function setCanvasSize(width, height) {
  d3.select('#map11').style('border', '1px solid white').style('background-color', 'white').style('margin-bottom', '10px').select('svg').attr('width', width).attr('height', height);
  d3.select('#map12').style('border', '1px solid white').style('background-color', 'white').select('svg').attr('width', width).attr('height', height).style('margin-top', '10px');
  d3.select('#map13').style('border', '1px solid black').style('background-color', 'white').select('svg').style('margin-bottom', '30px').style('margin-top', '10px').attr('width', width).attr('height', height);
  d3.select('#map21').style('border', '1px solid white').style('background-color', 'white').style('margin-bottom', '10px').select('svg').attr('width', width).attr('height', height);
  d3.select('#map22').style('border', '1px solid black').style('background-color', 'white').select('svg').attr('width', width).attr('height', height).style('margin-top', '10px').style('margin-bottom', '10px');
  d3.select('#map23').style('border', '1px solid black').style('background-color', 'white').select('svg').style('margin-bottom', '30px').style('margin-top', '10px').attr('width', width).attr('height', height);
}
/**
...
function appendGraphLabels() {
  // Label for graph 1
  d3.select('.graph11').select('.svg').append('text').text('Vue ensemble jeu 1').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)'); // Label for graph 2

  d3.select('.graph12').select('.svg').append('text').text('Vue ensemble jeu 2').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)'); // Label for graph 3

  d3.select('.graph13').select('.svg').append('text').text('Vue ensemble jeu 3').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)');
  d3.select('#tab1').selectAll('.svg').append('text').text('survolez pour plus d\'informations.').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Open Sans Condensed').attr('font-size', 18).attr('transform', 'translate(50, 85)'); // Tab view 2
  // Label for tab2 view1

  d3.select('.graph21').select('.svg').append('text').text('Performances tirs cadrés versus nombres de buts pour Killian Mbappe').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)'); // Label for tab2 view2

  d3.select('.graph22').select('.svg').append('text').text('Performances tirs cadrés versus nombres de buts pour Kharim  Benzema').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)'); // Label for tab2 view3

  d3.select('.graph23').select('.svg').append('text').text('Performances tirs cadrés versus nombres de buts pour Sadio Mane').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)');
  d3.select('#tab2').selectAll('.svg').append('text').text('survolez pour plus d\'informations.').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Open Sans Condensed').attr('font-size', 18).attr('transform', 'translate(50, 85)');
}
/**
...
function positionLabels(width, height) {
  d3.selectAll('.y-axis-text').attr('x', -300).attr('y', height * 2 / 5);
  d3.selectAll('.x-axis-text').attr('x', width * 3 / 4).attr('y', height * 5 / 4);
}
/**
...
function defineColorScale(colors, Attributs) {
...
function generateGV3(margin) {
  return d3.select('.graph3').select('svg').append('g').attr('id', 'graph3-g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
}
/**
 * Sets the size of the SVG canvas containing the graph.
 *
...
function setCanvasSizeV3(width, height) {
  d3.select('#map3').select('svg').attr('width', width).attr('height', height);
}
/**
...
function appendAxesV3(g) {
  g.append('g').attr('class', 'x axis');
  g.append('g').attr('class', 'y axis');
}

function drawXAxis(xScale, xScale1, height) {
  d3.selectAll('.x.axis').attr('transform', 'translate(0, ' + height + ')').call(d3.axisBottom(xScale).tickFormat(function (x) {
    return "Month ".concat(x);
  }));
  d3.selectAll('.x.axis1').attr('transform', 'translate(0, ' + height + ')').call(d3.axisBottom(xScale1).tickFormat(function (x) {
    return "Cat ".concat(x);
  }));
}
/**
...
function drawYAxis(yScale21, yScale22, yScale23, yScale11, yScale12, yScale13) {
...
exports.colorDomain = colorDomain;
exports.mapBackground = mapBackground;
exports.mapBackground2 = mapBackground2;
exports.showMapLabel = showMapLabel;
exports.mapMarkers = mapMarkers;
exports.setColorScaleDomainV3 = setColorScaleDomainV3;
exports.appendRectsV3 = appendRectsV3;
exports.updateXScaleV3 = updateXScaleV3;
exports.updateGroupXScale = updateGroupXScale;
exports.updateYScale = updateYScale;
exports.createGroups = createGroups;
exports.updateYScaleV3 = updateYScaleV3;
exports.drawXAxisV3 = drawXAxisV3;
exports.drawYAxisV3 = drawYAxisV3;
exports.rotateXTicksV3 = rotateXTicksV3;
exports.updateRectsV3 = updateRectsV3;
...
function mapBackground(data, path, showMapLabel) {
  // TODO : Generate the map background and set the hover handlers
  d3.select('#map-g').selectAll('path').data(data.features).enter().append('path').attr('d', function (d) {
    return path(d);
  }).style('fill', '#cdd1c3').attr('stroke', 'white').attr('stroke-width', '1px').on('mouseover', function (d) {
    return showMapLabel(d, path);
...
function mapBackground2(data, path) {
  // TODO : Generate the map background and set the hover handlers
  d3.select('#map-g21').selectAll('path').data(data).enter().append('path').attr('d', function (d) {
    return path(d);
  }).style('fill', '#cdd1c3').attr('stroke', 'white').attr('stroke-width', '5px'); //.on('mouseover', (d) => showMapLabel(d, path))
  //.on('mouseout', () => {
  //  d3.select('#neighborhoodName').style('visibility', 'hidden')
  ///})
  // d3.select('.main-svg').append('text').attr('id', 'neighborhoodName').attr('visibility', 'hidden')
...
function showMapLabel(d, path) {
  // TODO : Show the map label at the center of the neighborhood
  // by calculating the centroid for its polygon
  d3.select('#neighborhoodName').attr('x', path.centroid(d)[0]).attr('y', path.centroid(d)[1]).text(d.properties.NOM).style('text-anchor', 'middle').style('visibility', 'visible').style('font-size', 'smaller');
}
/**
...
function mapMarkers(data, color, panel) {
  ...
  d3.select('#marker-g').selectAll('circle').data(data.features).enter().append('circle').attr('class', 'marker').attr('r', '5').attr('cx', function (d) {
    return d.x;
  }).attr('cy', function (d) {
    return d.y;
  }).attr('fill', function (d) {
    return color(d.properties.TYPE_SITE_INTERVENTION);
  }).attr('stroke', 'white').attr('stroke-width', '1px').on('mouseover', function () {
...
function setColorScaleDomainV3(colorScale, data) {
  // TODO : Set domain of color scale
  var allData = data.map(function (elt) {
    return elt.Counts;
  });
  colorScale.domain([Math.min.apply(Math, _toConsumableArray(allData)), Math.max.apply(Math, _toConsumableArray(allData))]);
}
/**
...
function appendRectsV3(data) {
  // TODO : Append SVG rect elements
  d3.select('#graph3-g').selectAll('.element').data(data).enter().append('g').attr('class', 'element').append('rect');
}
/**
...
function updateXScaleV3(xScale, players, width) {
  // TODO : Update X scale
...
function updateYScale(yScale21, yScale22, yScale23, yScale11, yScale12, yScale13, data, dataG1, height) {
  ...
  data.forEach(function (elt) {
    elt.Attributs.forEach(function (row) {
...
function drawXAxisV3(xScale) {
  // TODO : Draw X axis
  d3.select('.main-svg3').select('.x.axis').call(d3.axisTop(xScale));
}
/**
...
function drawYAxisV3(yScale, width) {
  // TODO : Draw Y axis
  d3.select('.main-svg3').select('.y.axis').call(d3.axisRight(yScale)).attr('transform', "translate(".concat(width, ",0)"));
}
/**
...
function rotateXTicksV3() {
  // TODO : Rotate X axis' ticks
  d3.select('.main-svg3').select('.x.axis').selectAll('.tick').selectAll('text').attr('transform', 'rotate(-45)');
}
/**
...
function updateRectsV3(xScale, yScale, colorScale) {
  // TODO : Set position, size and fill of rectangles according to bound data
  d3.selectAll('.element').attr('transform', function (d) {
    return "translate(".concat(xScale(d.Players), ",").concat(yScale(d.Aspects), ")");
  }) // the d  name and the aspects
  .selectAll('rect').attr('width', xScale.bandwidth()).attr('height', yScale.bandwidth()).attr('fill', function (d) {
...
function drawBars(y21, y22, y23, y11, y12, y13, xSubgroup2, xSubgroup1, players, height, color2, color1, tip1, tip2, tip3, tip4) {
  // draw view 2 bars
  d3.select('#map-g211').selectAll('.attribut_month').selectAll('.rect').data(function (value) {
    return value.Attributs.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Months: value.Months
      });
    });
  }).enter().append('rect').attr('y', function (value) {
    return y21(value.Players[0].Count);
  }).attr('x', function (value) {
    return xSubgroup2(value.Attribut);
  }).attr('fill', function (value) {
    return color2(value.Attribut);
  }).attr('height', function (value) {
    return height - y21(value.Players[0].Count);
  }).attr('width', xSubgroup2.bandwidth()).on('mouseover', tip1.show).on('mouseout', tip1.hide);
  d3.select('#map-g221').selectAll('.attribut_month').selectAll('.rect').data(function (value) {
    return value.Attributs.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Months: value.Months
      });
    ...
    return y22(value.Players[1].Count);
  }).attr('x', function (value) {
    return xSubgroup2(value.Attribut);
  }).attr('fill', function (value) {
    return color2(value.Attribut);
  }).attr('height', function (value) {
    return height - y22(value.Players[1].Count);
  }).attr('width', xSubgroup2.bandwidth()).on('mouseover', tip2.show).on('mouseout', tip2.hide);
  d3.select('#map-g231').selectAll('.attribut_month').selectAll('.rect').data(function (value) {
    return value.Attributs.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Months: value.Months
      });
    ...
    return y23(value.Players[2].Count);
  }).attr('x', function (value) {
    return xSubgroup2(value.Attribut);
  }).attr('fill', function (value) {
    return color2(value.Attribut);
  }).attr('height', function (value) {
    return height - y23(value.Players[2].Count);
  }).attr('width', xSubgroup2.bandwidth()).on('mouseover', tip3.show).on('mouseout', tip3.hide); // draw view 1 bars

  d3.select('#map-g111').selectAll('.attribut_cat').selectAll('.rect').data(function (value) {
    return value.Players.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Cat: value.Cat
      });
    });
  ...
  d3.select('#map-g121').selectAll('.attribut_cat').selectAll('.rect').data(function (value) {
    return value.Players.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Cat: value.Cat
      });
  ...
  d3.select('#map-g131').selectAll('.attribut_cat').selectAll('.rect').data(function (value) {
    return value.Players.map(function (p) {
      return _objectSpread(_objectSpread({}, p), {}, {
        Cat: value.Cat
      });
...
exports.simplifyDisplayTitles = simplifyDisplayTitles;
...
function convertCoordinates(data, projection) {
  ...
  */
  data.features.forEach(function (feature) {
    var _projection = projection([feature.properties.LONGITUDE, feature.properties.LATITUDE]);

    var _projection2 = _slicedToArray(_projection, 2);

    feature.x = _projection2[0];
    feature.y = _projection2[1];
  });
}
/**
...
function simplifyDisplayTitles(data) {
...
function summarizeLinesV3(data) {
  ...
  return getPlayers.map(function (player) {
    return {
      Player: player,
      Tkl: countGoalV3(data.filter(function (row) {
        return parseInt(row.ID) === player;
      }))[0],
      Ast: countGoalV3(data.filter(function (row) {
        return parseInt(row.ID) === player;
      }))[1],
      Gls: countGoalV3(data.filter(function (row) {
        return parseInt(row.ID) === player;
      }))[2],
      Succ: countGoalV3(data.filter(function (row) {
        return parseInt(row.ID) === player;
      }))[3],
      Int: countGoalV3(data.filter(function (row) {
        return parseInt(row.ID) === player;
      }))[4]
    };
  }).filter(function (elt) {
  ...
  players.forEach(function (player) {
    ...
    aspects.forEach(function (aspect) {
      ...
      tableResult.push({
        "Players": player,
        "Aspects": aspect,
        "Counts": tabtemp[indexplayer][aspect]
      });
    });
  });
  return tableResult;
...
function countGoalV3(temps) {
  ...
  var temp = [tempTkl, tempAst, tempGls, tempSucc, tempInt];
  return temp;
}
...
function summarizeLines(data) {
  ...
  var getMonths = _toConsumableArray(new Set(data.map(function (row) {
    return parseInt(row.Date.substring(5, 7));
  }))).sort(function (a, b) {
    return a - b;
  });

  console.log(getMonths); // class by players, get all the players
  ...
  console.log(getPlayers); // return the structure

  return getMonths.map(function (month) {
    return {
      Months: month,
      Attributs: [{
        Attribut: 'SoT',
        Players: getPlayers.map(function (player) {
          return {
            Player: player,
            Count: countGoal(data.filter(function (row) {
              return parseInt(row.Date.substring(5, 7)) === month && parseInt(row.ID) === player;
            }))[0]
          };
        })
      }, {
...
var _default = index;
exports.default = _default;
},{"d3-selection":"../node_modules/d3-svg-legend/node_modules/d3-selection/index.js","d3-format":"../node_modules/d3-svg-legend/node_modules/d3-format/index.js","d3-dispatch":"../node_modules/d3-svg-legend/node_modules/d3-dispatch/index.js","d3-scale":"../node_modules/d3-svg-legend/node_modules/d3-scale/index.js","d3-array":"../node_modules/d3-svg-legend/node_modules/d3-array/index.js"}],"scripts/legend.js":[function(require,module,exports) {
"use strict";
...
exports.draw = draw;
exports.initGradientV3 = initGradientV3;
exports.initLegendBarV3 = initLegendBarV3;
exports.initLegendAxisV3 = initLegendAxisV3;
exports.drawV3 = drawV3;
...
function initGradientV3(colorScale) {
  var svg = d3.select('.main-svg3');
...
function drawV3(x, y, height, width, fill, colorScale) {
  // TODO : Draw the legend
  d3.select('.main-svg3 .legend.bar').attr('width', width).attr('height', height).attr('x', x).attr('y', y).attr('fill', fill);
  var axis = d3.axisLeft(d3.scaleLinear().domain(colorScale.domain()).range([height, 0])).ticks(7);
  d3.select('.main-svg3 .legend.axis').attr('transform', "translate(".concat(x, ", ").concat(y, ")")).call(axis);
}
...
function display(d, color) {
  var panel = d3.select('#panel1').style('visibility', 'visible');
...
function setTitle(g, d, color) {
  // TODO : Set the title
  g.append("text").style("color", color(d.properties.TYPE_SITE_INTERVENTION)).text(d.properties.NOM_PROJET);
}
/**
...
function setMode(g, d) {
  // TODO : Set the mode
  g.append("text").text(d.properties.MODE_IMPLANTATION);
}
/**
...
exports.setRectHandlerV3 = setRectHandlerV3;
exports.rectSelectedV3 = rectSelectedV3;
exports.rectUnselectedV3 = rectUnselectedV3;
exports.selectTicksV3 = selectTicksV3;
exports.unselectTicksV3 = unselectTicksV3;
 ...
 */
function setRectHandlerV3(xScale, yScale, rectSelected, rectUnselected, selectTicks, unselectTicks) {
  // TODO : Select the squares and set their event handlers
  d3.selectAll('.element').on('mouseenter', function (elt) {
...
function rectSelectedV3(element, xScale, yScale) {
  ...
  d3.select(element).append('text').text(function (elt) {
    return elt["Counts"];
  }).attr('fill', function (elt) {
    return elt["Counts"] < 100 ? 'black' : 'white';
  }).attr('opacity', 0.75).attr('x', function (elt) {
    return (xScale.bandwidth() - 10 * elt["Counts"].toString().length) / 2;
  }).attr('y', function (elt) {
    return (yScale.bandwidth() + 10) / 2;
  });
}
/**
...
function rectUnselectedV3(element) {
  // TODO : Unselect the element
  d3.select(element).attr('opacity', 1.0).select('text').remove();
}
/**
...
function selectTicksV3(name, year) {
  // player and aspect
  // TODO : Make the ticks bold
  d3.selectAll('.tick').filter(function (content) {
    return content == name || content == year;
...
},{"d3-collection":"../node_modules/d3-collection/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js"}],"scripts/tooltip.js":[function(require,module,exports) {
"use strict";
...
var panel = _interopRequireWildcard(require("./scripts/panel.js"));
...
(function (d3) {
  ...
  helper.appendGraphLabels(); // set the view to the default
  ...
  function build() {
    var tip1 = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
      return tooltip.getContents(d, 1);
    });
    var tip2 = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
      return tooltip.getContents(d, 2);
    });
    var tip3 = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
      return tooltip.getContents(d, 3);
    });
    d3.select('.graph21').select('.svg').call(tip1);
    d3.select('.graph22').select('.svg').call(tip2);
    d3.select('.graph23').select('.svg').call(tip3);
    var tip4 = (0, _d3Tip.default)().attr('class', 'd3-tip').html(function (d) {
      return tooltip.getContents(d, 4);
    });
  ...
  var xScaleV3 = d3.scaleBand().padding(0.05);
  var yScaleV3 = d3.scaleBand().padding(0.2);
  ...
  d3.csv('./data.csv', d3.autoType).then(function (data) {
    ...
    var g = helper.generateGV3(marginV3);
...
},{"./scripts/helper.js":"scripts/helper.js","./scripts/viz.js":"scripts/viz.js","./scripts/preprocess.js":"scripts/preprocess.js","./scripts/legend.js":"scripts/legend.js","./scripts/panel.js":"scripts/panel.js","./scripts/hover.js":"scripts/hover.js","d3-scale-chromatic":"../node_modules/d3-scale-chromatic/src/index.js","d3-tip":"../node_modules/d3-tip/index.js","./scripts/tooltip.js":"scripts/tooltip.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
