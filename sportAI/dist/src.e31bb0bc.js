...
function appendGraphLabels() {
  // Label for graph 1
  d3.select('.main-svg1').append('text').text('Explorez les rues pietonnes de Montréal').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)');
  d3.select('.main-svg1').append('text').text('Cliquez sur un marqueur pour plus d\'information.').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Open Sans Condensed').attr('font-size', 18).attr('transform', 'translate(50, 85)'); // Label for graph 2

  d3.select('.main-svg2').append('text').text('Explorez les rues pietonnes de Montréal').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Oswald').attr('font-size', 28).attr('transform', 'translate(50, 50)');
  d3.select('.main-svg2').append('text').text('Cliquez sur un marqueur pour plus d\'information.').attr('class', 'title').attr('fill', '#000000').attr('font-family', 'Open Sans Condensed').attr('font-size', 18).attr('transform', 'translate(50, 85)');
}
/**
 ...
 */
function drawLegend(colorScale, g) {// TODO : Generate the legend
...
(function (d3) {
  ...
  function build() {
    ...
    d3.json('./projetpietonnisation2017.geojson').then(function (data) {
      ...
      var simulation = helper.getSimulation(data);
  ...
  d3.csv('./stats_summary_GLOBAL.csv', d3.autoType).then(function (data) {
    ...
    var g = helper.generateGV3(margin);
